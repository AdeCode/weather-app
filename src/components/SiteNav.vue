    ...
    >
      <div class="text-black">
        ...
        <ol class="list-decimal list-inside mb-4">
          ...
          <li>Search a city within the results, this will take you to the current weather for your selection.</li>
        ...
        <p>
          If you no longer wish to track a city, simply select the city with the home page. At  the bottom of the page,
